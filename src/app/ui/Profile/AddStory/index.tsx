  ...
  return (
    <div className="flex flex-row gap-4 p-4">
      ...
      <div className="flex flex-col items-center group cursor-pointer">
        ...
        <div className="relative w-16 h-16 mb-1 group-hover:scale-105 transition-transform duration-300">
          {/* Gradient ring */}
      ...
      <div className="flex flex-col items-center cursor-pointer">
        {/* Story ring with Instagram-like gradient */}
        <div className="relative w-16 h-16 mb-1 hover:scale-105 transition-transform duration-300">
          {/* Gradient ring */}
